...
export default function Page() {
  ...
  return (
    <div className='flex max-md:flex-col items-center justify-center w-full h-full absolute top-0 left-0 bg-gradient-to-tr from-[#326B23]/70 at-[50%] to-[#79513E]/70 at-[50%] max-md:px-20'>
